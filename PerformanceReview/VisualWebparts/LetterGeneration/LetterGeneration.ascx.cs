...
namespace PerformanceReview.VisualWebparts.LetterGeneration
{
    [ToolboxItemAttribute(false)]
    public partial class LetterGeneration : WebPart
    {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string ExistColumn = objreadexcel.LetterColumnValidation(objfileupload);
                if (ExistColumn == "")
                {
                    try
                    {
                        UploadExcelToSPList objupload = objreadexcel.UploadExcelFileToSPLetterGenerationList(objfileupload);
                    ...
                    catch (Exception ex)
                    {
                        ...
                        objerror.WriteExceptionLog(ex.Message, "Letter Generation-btnUpload_Click");
                    }
                }
                else
                {
