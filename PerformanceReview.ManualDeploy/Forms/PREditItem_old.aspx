			...
			<div class="container">
				...
				<table class="table table-bordered" >
					<tr>
						...
						<td width="400px" valign="top" class="ms-formbody cellctrl" style="display:none;">
							<SharePoint:FormField runat="server" id="ff17{$Pos}" ControlMode="Edit" FieldName="Name_PR" __designer:bind="{ddwrt:DataBind('u',concat('ff17',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Name_PR')}"/>
							<SharePoint:FieldDescription runat="server" id="ff17description{$Pos}" FieldName="Name_PR" ControlMode="Edit"/>
						</td>
						<td class="span3">
						<div class="ms-formbody">
						...
						<td class="span3" id="tdPR">
						<div class="ms-formbody">
							<SharePoint:FormField runat="server" id="ff24{$Pos}" InDesign="true" ControlMode="Edit" FieldName="PR" __designer:bind="{ddwrt:DataBind('u',concat('ff24',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@PR')}"/>
							<SharePoint:FieldDescription runat="server" id="ff24description{$Pos}" FieldName="PR" ControlMode="Edit"/></div>
						</td>
						<td width="190px" valign="top" class="ms-formlabel" style="display:none">
							<H3 class="ms-standardheader">
								<nobr>Name_IPA</nobr>
						...
						<td width="400px" valign="top" class="ms-formbody cellctrl" style="display:none;">
							<SharePoint:FormField runat="server" id="ff16{$Pos}" ControlMode="Edit" FieldName="Name_IPA" __designer:bind="{ddwrt:DataBind('u',concat('ff16',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Name_IPA')}"/>
							<SharePoint:FieldDescription runat="server" id="ff16description{$Pos}" FieldName="Name_IPA" ControlMode="Edit"/>
						</td>
						<td class="span3" >
						<div class="ms-formbody">

							<xsl:value-of select="@Name_IPA" disable-output-escaping="yes"/></div>
						</td>
						<td width="190px" valign="top" class="ms-formlabel" style="display:none">
							<H3 class="ms-standardheader">
								<nobr>IPA</nobr>
						...
						<td class="span3" id="tdIPA">
						<div class="ms-formbody">

							<SharePoint:FormField runat="server" id="ff13{$Pos}" ControlMode="Edit" FieldName="IPA" __designer:bind="{ddwrt:DataBind('u',concat('ff13',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@IPA')}"/>
							<SharePoint:FieldDescription runat="server" id="ff13description{$Pos}" FieldName="IPA" ControlMode="Edit"/></div>
						</td>
					</tr>
				</table>
